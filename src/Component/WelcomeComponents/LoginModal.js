...
import connect from '../../images/connect.png' // import gmail from '../../images/g-icon.png'
...
export default function LoginModal(props) {
  ...
  const {loginUser } = useContext(UserContext) //implement signUpWithGoogle, signUpWithGithub
